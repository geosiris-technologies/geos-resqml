...
namespace EML2_NS
{
	...
	class MyHdfProxyMPI : public AbstractHdfProxy
	{
	public:
		 ...
		 */
		MyHdfProxyMPI(gsoap_resqml2_0_1::eml20__DataObjectReference* partialObject) : AbstractHdfProxy(partialObject) {}
		 ...
		 * @param 	dor	The dor.
		 */
		MyHdfProxyMPI(const COMMON_NS::DataObjectReference& dor) : AbstractHdfProxy(dor) {}
		 ...
		 */
		MyHdfProxyMPI(COMMON_NS::DataObjectRepository * repo, const std::string & guid, const std::string & title,
	...
	protected:
		 ...
		 */
		MyHdfProxyMPI(gsoap_resqml2_0_1::_eml20__EpcExternalPartReference* fromGsoap) :
		 ...
		 * @param 	hdfPermissionAccess   	(Optional) The hdf permission access.
		 */
		//MyHdfProxyMPI(const std::string & packageDirAbsolutePath, const std::string & externalFilePath, COMMON_NS::DataObjectRepository::openingMode hdfPermissionAccess = COMMON_NS::DataObjectRepository::openingMode::READ_ONLY);
