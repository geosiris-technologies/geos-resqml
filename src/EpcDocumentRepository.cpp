...
void EpcDocumentRepository::postInputInitialization()
{
...
void EpcDocumentRepository::open()
{}

REGISTER_CATALOG_ENTRY( ExternalDataRepositoryBase, EpcDocumentRepository, string const &,
                        Group * const )
