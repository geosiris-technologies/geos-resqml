...
EML2_NS::AbstractHdfProxy* MyHdfProxyMPIFactory::make(COMMON_NS::DataObjectRepository * repo, const std::string & guid, const std::string & title,
	...
	COMMON_NS::DataObjectRepository::openingMode hdfPermissionAccess)
{
	...
	case COMMON_NS::DataObjectRepository::EnergisticsStandard::EML2_0:
		return new EML2_NS::MyHdfProxyMPI(repo, guid, title, packageDirAbsolutePath, externalFilePath, hdfPermissionAccess);
	default:
